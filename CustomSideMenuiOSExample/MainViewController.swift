...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        showViewController(viewController: UINavigationController.self, storyboardId: "SettingsNavID")
    }
...
extension MainViewController: SideMenuViewControllerDelegate {
    ...
    func logoff() {
        DispatchQueue.main.async { self.sideMenuState(expanded: false) }
        // Create Alert
        let dialogMessage = UIAlertController(title: "LOG OFF", message: "Are you sure want to log off?", preferredStyle: .alert)

        // Create OK button with action handler
        let ok = UIAlertAction(title: "Log Off", style: .destructive, handler: { (action) -> Void in
